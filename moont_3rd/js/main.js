...
window.addEventListener("DOMContentLoaded",
    function () {
        ...
        // 블릿 click이벤트 설정하기
        // for(시;한;증){}
        // 지역변수 선언을 var로 하지않고 let로 하면 for문 내부에 있는 익명함수 내부로 i값이 전달된다!!!!!
        // let는 영역변수라고함!!!!(별도의 설명예정!!)
        ...
        */ ////////////////////////////////////////////
        var goSlide = function (dir, seq) {
            ...
            if (dir===1) { // dir이 1일때 true : 오른쪽버튼
                snum++; //1씩증가
                if (snum === 2) snum = 0; //한계수
            } /////// if ///////////////////////
            else if(dir===0) { // dir이 0일때 : 왼쪽버튼
                snum--; //1씩감소
                if (snum < 0) snum = 1; //한계수
            }/////// else if /////
            else if(dir===1){
                snum = seq;
            }///// else if /////
            ...
            // 2.슬라이드 이동하기
            var tg = document.querySelector('.banbox');
            tg.style.opacity = (1 * snum) ;
            tg.style.transition = "opacity .4s ease-out";
